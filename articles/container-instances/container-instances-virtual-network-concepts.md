...
NAT gateway should be configured with public IP so the container groups outbound flows through that public IP. This also allows customer to use service tagged IPs and/or have appropriate NSG rules.
